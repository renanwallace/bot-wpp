/**
 * Este script contém funções WAPI que precisam ser executadas no contexto da página da web
 */


/**
 * Descoberta automática das referências de objeto do webpack de instâncias que contêm todas as funções usadas pela WAPI
 * cria o objeto "Store"
 */
...
/**
 * Serializa um objeto de bate-papo
 *
...
/**
 * Busca todos os objetos de contato da loja e os filtra
 *
 * @param done Função de retorno de chamada opcional para execução assíncrona
...
/**
 * Busca o objeto de contato da Store por ID
 *
...
/**
 * Busca todos os chats da Store por ID
 *
 * @param done Função de retorno de chamada opcional para execução assíncrona
...
/**
 * Busca todos os chats id da Store por ID
 *
 * @param done Função de retorno de chamada opcional para execução assíncrona
...
/**
 * Busca todos os objetos de grupo da Store
 *
 * @param done Função de retorno de chamada opcional para execução assíncrona
 * @returns {Array|*} List of chats
 */
...
window.WAPI.getUnreadMessagesInChat = function (id, includeMe, includeNotifications, done) {
    // obtem bate-papo e suas mensagens
    ...
    // procura mensagens não lidas, a mais recente está no final da matriz
    for (let i = messages.length - 1; i >= 0; i--) {
        ...
        // encontrou uma mensagem lida: para de procurar outras
